...
def execute_ssh_command(command):
  ...
  port = 22
  username = "david"
  private_key_path = os.expandvars("~\.ssh\id_rsa")
...
class PalatialBuildServer:
    ...
    def buildProject(self, projectId):
        ...
        project_path = "/mnt/Palatial_V01_UE53/Palatial_V01_UE53.uproject"
        output_directory = "."
...
if __name__ == '__main__':
    ...
    project_dir = "/mnt/Palatial_V01_UE53"

    os.chdir(project_dir)

    print("Updating project repository...")
